...
static const Key keys[] = {
  ...
  // 减少音量
	{ 0,      	XF86XK_AudioLowerVolume,   spawn,          SHCMD("bash ~/.config/dwm/scripts/volume_control.sh down")},
  // 增加音量
	{ 0,      	XF86XK_AudioRaiseVolume,   spawn,          SHCMD("bash ~/.config/dwm/scripts/volume_control.sh up")},
